-- ========================================
-- TuranSound - Полная установка базы данных
-- ========================================
-- Этот файл объединяет ВСЕ миграции для быстрой установки
-- Выполните этот файл ОДИН РАЗ вместо всех других миграций
-- ========================================
...
COMMENT ON TABLE public.reviews IS 'Отзывы о работе артистов';
